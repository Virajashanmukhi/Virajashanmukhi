...
♻️ Built a Smart Waste Management System using Arduino for automatic waste segregation for which I got first Prize in Project Expo.This separates wet, dry, metal, and non-metal waste using Arduino and sensors.
Used different sensors like moisture sensor, proximity sensor

🏨 Created a Hotel Management System using Python, Tkinter, and MySQL.

📈 Designed a Hotel Booking Analysis Dashboard for business insights.For this Power BI and Excel is used.
